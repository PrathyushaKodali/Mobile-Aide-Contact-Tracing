...
public class UploadChat extends AsyncTask<String,String,String> {

    final static String TAG = "UploadChat";
    @Override
    protected String doInBackground(String... strings) {
        try {
            ...
            File chatFile = new File(Environment.getExternalStorageDirectory()+File.separator+"my_folder"+File.separator+"chat.txt");
            ...
            try (
                ...
                // Send db file.
                writer.append("--" + boundary).append(CRLF);
                writer.append("Content-Disposition: form-data; name=\"uploaded_file\"; filename=\"" + chatFile.getName() + "\"").append(CRLF);
                ...
                FileInputStream vf = new FileInputStream(chatFile);
                try {
